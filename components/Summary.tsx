    ...
    return (
        <div id="summary" className="flex flex-col items-center gap-2 w-full">
            ...
            <div id="basic-summary-info" className="flex flex-col w-full justify-between gap-0.25">
                    <div className="flex gap-2 w-full items-center justify-center bg-[var(--color-list-bg-green)] text-green-100 p-1 border-1 border-[var(--color-dark-blue)]">
                        <h4>Income:</h4>
                        <div className="flex">
                    ...
                    <div className="flex gap-2 w-full items-center justify-center bg-[var(--color-list-bg-red)] text-red-300 p-1 border-1 border-[var(--color-dark-blue)]">
                        <h4>Expence:</h4>
                        <div className="flex">
                    ...
                    <div className="flex gap-2 w-full items-center justify-center bg-sky-800 text-sky-300 p-1 border-1 border-[var(--color-dark-blue)]">
                        <h5>Net Balance:</h5>
                        <div className="flex">
